...
public class BkRynekScreen extends Screen {
    ...
    // @Override removed - method no longer exists in superclass but invoked by
    // Fabric/Game
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        handleManualInput(mouseX, mouseY);
    }
    ...
    private void handleManualInput(double mouseX, double mouseY) {
        if (this.client == null)
            return;
        long handle = this.client.getWindow().getHandle();
        boolean isMouseDown = org.lwjgl.glfw.GLFW.glfwGetMouseButton(handle,
