...
public class ColorUtils {
    ...
    private static void appendWithLinks(MutableText root, String text, Style style) {
        ...
        while (matcher.find()) {
            ...
            Style linkStyle = style.withClickEvent(new ClickEvent.OpenUrl(java.net.URI.create(target)))
                    .withHoverEvent(new HoverEvent.ShowText(Text.literal("Otwórz: " + target)));
